...
Write-Host "CREATING DATACENTER IF IT DOES NOT EXIST"
...
Write-Host "CREATING VMWARE CLUSTER IF IT DOES NOT EXIST"
...
Write-Host "CONFIGURING VMWARE CLUSTER SETTINGS"
...
Write-Host "CONFIGURING VMWARE CLUSTER ADMISSION CONTROL PERCENTAGES"
...
Write-Host "CONFIGURING VMWARE CLUSTER HA SETTINGS"
...
Write-Host "ADDING HOSTS TO VMWARE CLUSTER"
...
# Configure CVM-specific HA & DRS settings
# Note that this builds a list of VMs that have "CVM" in their name ...

Write-Host "CONFIGURING CVM SPECIFIC CLUSTER HA & DRS SETTINGS"
